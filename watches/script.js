import { initializeApp } from 'https://www.gstatic.com/firebasejs/10.7.1/firebase-app.js';
        ...
        window.setMood = async (mood) => {
          ...
          document.querySelector(`.mood-btn.${mood}`).classList.add('active');
            ...
            (snapshot) => {
              ...
              if (userData) {
                ...
                if (userData.mood) {
                  ...
                  document.querySelectorAll('.mood-btn').forEach(btn => btn.classList.remove('active'));
                  const activeMoodBtn = document.querySelector(`.mood-btn.${userData.mood}`);
                  if (activeMoodBtn) {
        ...
        function createTimerCard(timer) {
          ...
          // Apply mood styling if it's the current user's card
          const mood = timer.mood || 'chillen';
          if (currentUser && timer.email === currentUser.email) {
